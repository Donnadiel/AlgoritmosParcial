...
public class Complex {
    ...
    public int getCounterRadixSize() {
        return counterRadixSize;
    }
    ...
    public void setListPivot(){
        this.listPivot = "";
    }

    public void setListLow(){
        this.listLow = "";
    }

    public void setListHigh(){
        this.listHigh = "";
    }
    ...
    public void setCounterRadix(int[] counterRadix) {this.counterRadix = counterRadix;}

    public String getListLowMerge() {return listLowMerge;}

    public void setListLowMerge(String listLowMerge) {this.listLowMerge = listLowMerge;}

    public String getListHighMerge() {return listHighMerge;}

    public void setListHighMerge(String listHighMerge) {this.listHighMerge = listHighMerge;}

    public int getRecursiveCallingMerge() {return recursiveCallingMerge;}

    public void setRecursiveCallingMerge(int recursiveCallingMerge) {this.recursiveCallingMerge = recursiveCallingMerge;}
